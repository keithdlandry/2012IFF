...
const int nPhisrBins = 16;    //moved from 16 to 32 on 4/29/2014 //back to 16 bins 6/17/15 for possible better fit with less stats
...
void calcAsymKPi(){
  ...
  TFile* infile = new TFile("/star/u/klandry/ucladisk/2012IFF/dihadron/diHadOut_smallPbins_5_19/allSmallPBins.root");
	...
	string outFileName = "./resDiHad_smallPbins_5_19/cone03AsymsHiEta_5_19_smallPbins_16bins.root"; 
