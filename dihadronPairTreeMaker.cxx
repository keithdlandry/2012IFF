...
//______________________________________________________________________________
void dihadronPairTreeMaker::deselectAllPairs()
{
  mMakePiPi_pairs = false;
  mMakeKaPi_pairs = false;
  mMakeKaKa_pairs = false;
}
//______________________________________________________________________________
...
Int_t dihadronPairTreeMaker::Make()
{
  ...
  mMakeKaKa_pairs = true;
  mMakeKaPi_pairs = true;
  ...
  //loop over tracks once
	for (int iTrack = 0; iTrack < muDst->numberOfPrimaryTracks()-1; iTrack++)
	{
      ...
      //double dca1 = track1->dca(track1->vertexIndex()).mag();
        ...
        if (mMakeKaPi_pairs || mMakeKaKa_pairs)
        {
