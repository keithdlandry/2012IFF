...
const int nPhisrBins = 16;    //moved from 16 to 32 on 4/29/2014
...
double    massBinStart[nMassBins] = {.86};
double    massBinEnd[nMassBins]   = {1.1};
...
void calc2dAsymKPi(){
  ...
  TFile* infile = new TFile("/star/u/klandry/ucladisk/2012IFF/dihadron/diHadOut_smallPbins_5_19/allSmallPBins.root");
	
	string outFileName = "./resDiHad_smallPbins_5_19/2Dcone03AsymsHiEta_5_19_smallPbins_16bins.root"; 
